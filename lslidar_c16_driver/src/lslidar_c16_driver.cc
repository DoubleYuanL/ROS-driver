...
LslidarC16Driver::LslidarC16Driver(
    ...
    bool LslidarC16Driver::loadParameters() {
      ...
      //add by lsy
      pnh.param<bool>("is_publish", is_publish, true);
      pnh.param<bool>("is_shutdown", is_shutdown, false);
    ...
    bool LslidarC16Driver::polling(){
        ...
        // reading and publishing scans as fast as possible.由于激光雷达以很高的速率传输数据，因此请尽可能快地保持读取和发布扫描。
